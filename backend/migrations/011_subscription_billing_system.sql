...
VALUES
  ('Trial', 'trial', '14-day trial for new workspaces.', 0, 0, 1, 1, 1, 100,
   '{"crm":true,"contacts":true,"leads":true,"basic_analytics":true,"ai_assistant":false,"shared_inbox":false,"broadcast_messaging":false,"knowledge_base":false,"knowledge_base_upload":false,"api_access":false,"workflow_automation":false,"advanced_automations":false,"lead_scoring":false,"campaign_analytics":false,"custom_branding":false,"team_permissions":false,"advanced_reporting":false,"integrations":false,"ai_sales_agent":false,"ai_support_agent":false,"white_label":false,"custom_ai_models":false}'::jsonb, true),
  ('Starter', 'starter', 'Start with AI WhatsApp CRM for one operator.', 3000, 30000, 1, 1, 1, 1000,
   '{"crm":true,"contacts":true,"leads":true,"lead_pipeline":true,"basic_analytics":true,"ai_assistant":true,"broadcast_messaging":true,"knowledge_base":true,"knowledge_base_upload":true,"shared_inbox":false,"api_access":false,"workflow_automation":false,"advanced_automations":false,"lead_scoring":false,"campaign_analytics":false,"custom_branding":false,"team_permissions":false,"advanced_reporting":false,"integrations":false,"ai_sales_agent":false,"ai_support_agent":false,"white_label":false,"custom_ai_models":false}'::jsonb, true),
  ('Growth', 'growth', 'Shared inbox and automations for growing teams.', 25000, 250000, 5, 3, NULL, 5000,
   '{"crm":true,"contacts":true,"leads":true,"lead_pipeline":true,"basic_analytics":true,"ai_assistant":true,"broadcast_messaging":true,"knowledge_base":true,"knowledge_base_upload":true,"shared_inbox":true,"workflow_automation":true,"lead_scoring":true,"campaign_analytics":true,"custom_branding":true,"api_access":false,"advanced_automations":true,"team_permissions":false,"advanced_reporting":false,"integrations":false,"ai_sales_agent":false,"ai_support_agent":false,"white_label":false,"custom_ai_models":false}'::jsonb, true),
  ('Business', 'business', 'Advanced agents, reporting, and integrations.', 60000, 600000, 20, 10, NULL, 20000,
   '{"crm":true,"contacts":true,"leads":true,"lead_pipeline":true,"basic_analytics":true,"ai_assistant":true,"broadcast_messaging":true,"knowledge_base":true,"knowledge_base_upload":true,"shared_inbox":true,"workflow_automation":true,"lead_scoring":true,"campaign_analytics":true,"custom_branding":true,"ai_sales_agent":true,"ai_support_agent":true,"team_permissions":true,"advanced_reporting":true,"integrations":true,"api_access":true,"white_label":false,"custom_ai_models":false}'::jsonb, true),
